...
public static class ExtensionMethods
{
    ...
    public static T CopyPropertiesFrom<T>(this T target, object source, string[]? ignoreProperties) =>
        CopyFrom<T>(target, source, ignoreProperties);
    ...
    public static void Log(this ControllerBase controller, string msg = "", [CallerMemberName] string callerMethod = "")
    {
        ...
        Console.ForegroundColor = method == "GET" ? ConsoleColor.Green :
            method == "DELETE" ? ConsoleColor.Red : ConsoleColor.Cyan;
    ...
    public static void Log(this Microsoft.AspNetCore.SignalR.Hub hub, string msg = "",
