...
namespace TennisDb.Migrations
{
    ...
    [Migration("20260917080822_AddClubEventsAndOetvMatches")]
    partial class AddClubEventsAndOetvMatches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TennisDb.AvailabilitySlot", b =>
                {
                    ...
                    b.Property<int?>("MatchedWithPlayer2Id")
                        .HasColumnType("integer");

                    b.Property<int?>("MatchedWithPlayer3Id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MatchedWithPlayer2Id");

                    b.HasIndex("MatchedWithPlayer3Id");

                    b.HasIndex("MatchedWithPlayerId");
            ...
            modelBuilder.Entity("TennisDb.OetvMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TennisDb.Player", b =>
                {
                    ...
                    b.Property<DateTime?>("LastItnUpdate")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<string>("NuLigaPlayerUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TennisDb.AvailabilitySlot", b =>
                {
                    b.HasOne("TennisDb.Player", "MatchedWithPlayer2")
                        .WithMany()
                        .HasForeignKey("MatchedWithPlayer2Id");

                    b.HasOne("TennisDb.Player", "MatchedWithPlayer3")
                        .WithMany()
                        .HasForeignKey("MatchedWithPlayer3Id");

                    b.HasOne("TennisDb.Player", "MatchedWithPlayer")
                        .WithMany()
                        .HasForeignKey("MatchedWithPlayerId");
                    ...
                    b.Navigation("MatchedWithPlayer");

                    b.Navigation("MatchedWithPlayer2");

                    b.Navigation("MatchedWithPlayer3");
            ...
            modelBuilder.Entity("TennisDb.PyramidChallenge", b =>
                {
                    b.HasOne("TennisDb.Team", "ChallengerTeam")
                        .WithMany()
                    ...
                    b.HasOne("TennisDb.Team", "DefenderTeam")
                        .WithMany()
                        .HasForeignKey("DefenderTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TennisDb.Team", "WinnerTeam")
                        .WithMany()
